  ...
  return (
    <div className="font-Roboto bg-white border-t-4 border-yellow-900 flex flex-col items-center justify-center text-center p-6">
      ...
      <div className="flex justify-center gap-4 md:gap-6">
        ...
        >
          <FontAwesomeIcon icon={faGithub} className='w-8 h-8 md:w-10 md:h-10 text-black' />
        </a>
        <a 
          ...
          className="hover:text-gray-500 transition"
        >
          <FontAwesomeIcon icon={faLinkedin} className='w-8 h-8 md:w-10 md:h-10 text-black' />
        </a>
      </div>
    </div>
  );
